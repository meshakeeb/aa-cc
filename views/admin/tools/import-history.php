...
?>
<div class="advads-import-history">
	<header>
		<h2><?php esc_html_e( 'Import History', 'advanced-ads' ); ?></h2>
		<p class="text-base"><?php esc_html_e( 'Import history to rollback changes.', 'advanced-ads' ); ?></p>
	</header>
