...
?>
<div class="advads-plugin-importer">
	<header>
		<h2><?php esc_html_e( 'Plugin Settings', 'advanced-ads' ); ?></h2>
		<p class="text-base"><?php esc_html_e( 'Import or export your Advanced Ads settings, This option is useful for replicating the ads configuration across multiple websites.', 'advanced-ads' ); ?></p>
	</header>
		...
		<div class="advads-tab-content">
			...
			<form id="export" class="advads-tab-target" method="post" action="<?php echo esc_url( Params::server( 'REQUEST_URI' ) ); ?>#export">
				<div class="advads-tab-content-body">
					...
					<p class="text-base"><?php esc_html_e( 'When you click the button below Advanced Ads will create an XML file for you to save to your computer.', 'advanced-ads' ); ?></p>
