...
?>
<div class="advads-other-plugin-importer">
	<header>
		<h2><?php esc_html_e( 'Other Plugins', 'advanced-ads' ); ?></h2>
		<p class="text-base"><?php esc_html_e( 'To make things even easier, we are working on new ways to import your settings and data from other plugins.', 'advanced-ads' ); ?></p>
	</header>
