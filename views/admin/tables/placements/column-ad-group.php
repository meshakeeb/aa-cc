...
<?php else : ?>
	...
	<div class="advads-placement-item-select-wrap">
		...
		<span class="advads-ajax-feedback advads-success-message dashicons dashicons-yes-alt"></span>
		<div class="advads-ajax-feedback card advads-notice-block advads-error"></div>
	</div>
	<?php
endif;
/**
