...
$enable_reserve_space = $show_reserve_space && ! empty( $ad->get_prop( 'add_wrapper_sizes' ) );
?>
...
<div id="advanced-ads-ad-parameters-size">
	...
	<label<?php echo ! $show_reserve_space ? ' style="display:none;"' : ''; ?>>
		<input type="checkbox" id="advads-wrapper-add-sizes" name="advanced_ad[output][add_wrapper_sizes]" value="true" <?php checked( $enable_reserve_space ); ?>><?php esc_html_e( 'reserve this space', 'advanced-ads' ); ?>
	</label>
	<?php
