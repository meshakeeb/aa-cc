...
jQuery(document).ready(function ($) {
	...
	$( '#advads-show-filters' ).on( 'click', function () {
		...
		$( '.advads-page .search-box' ).toggle( ! disabled );
		$( '.advads-page .tablenav.top .alignleft.actions:not(.bulkactions)' ).toggle( ! disabled );
...
window.Advanced_Ads_Admin = window.Advanced_Ads_Admin || {
	init_ad_source_editor() {},
	get_ad_source_editor_text() {
		let text = '';
	...
	set_ad_source_editor_text(text) {
		if (Advanced_Ads_Admin.editor && Advanced_Ads_Admin.editor.codemirror) {
