...
class Advanced_Ads_Admin_Settings {
	...
	public function settings_init() {
		...
		add_filter( 'advanced-ads-setting-tabs', [ $this, 'adblocker_tab' ] );
		...
		// add setting fields for ip address.
		add_settings_field(
			'hide-for-ip-address',
	 ...
	 * @return array $tabs
	 */
	public function adblocker_tab( array $tabs ) {
	...
	public function render_settings_hide_for_ip_address() {
		...
		include ADVADS_ABSPATH . 'admin/views/settings/general/hide-for-ip-address.php';
	}
