 ...
 */
function get_the_placement( $placement_id = 0, $new_type = '', $args = [] ): string {
	// Early bail!!
 ...
 * @return void
 */
function wp_advads_delete_placement( &$placement, $args = [] ): void {
	wp_advads_get_placement_repository()->delete( $placement, $args = [] );
}
 ...
 */
function wp_advads_get_placement_types(): array {
	return wp_advads_get_placement_type_manager()->get_types();
}
