...
class Placement_Repository {
	...
	/**
	 * Placement options metakey
	 *
	 * @var string
	 */
	const OPTION_METAKEY = 'advanced_ads_placement_options';
	 ...
	 * @return void
	 */
	public function delete( &$placement, $args = [] ): void {
		$id   = $placement->get_id();
	...
	private function update_post_meta( &$placement ): void {
		// Sanitize conditions.
		$placement->set_display_conditions(
			WordPress::sanitize_conditions( $placement->get_display_conditions() )
		);
