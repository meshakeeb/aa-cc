...
class Group extends Data {
	...
	public function set_name( $name ): void {
		$this->set_prop( 'name', sanitize_text_field( wp_unslash( $name ) ) );
	}
	...
	public function set_publish_date( $date ): void {
		update_term_meta( $this->get_id(), 'publish_date', $date );
	}
	...
	public function set_modified_date( $date ): void {
		update_term_meta( $this->get_id(), 'modified_date', $date );
	}
	...
	private function get_label(): string {
		if ( null === $this->label ) {
			...
			$this->label = Advanced_Ads::get_instance()->get_label( $state );
		}
