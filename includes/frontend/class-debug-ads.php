...
class Debug_Ads implements Integration_Interface {
	...
	public function hooks(): void {
		add_action( 'advanced-ads-ad-select-override-by-ad', [ $this, 'override_ad_output' ], 10, 3 );
	}

	/**
	 * Override ad output.
	 *
	 * @param bool  $override Override content.
	 * @param Ad    $ad       Ad object.
	 * @param array $args     Additional arguments.
	 *
	 * @return string|bool
	 */
	public function override_ad_output( $override, $ad, $args ) {
