...
function advads_save_new_placement( $data ) {
	...
	$placement_type = wp_advads_has_placement_type( $placement_type ) ? $placement_type : 'default';
 ...
 * @return void
 */
function advads_upgrade_1_50_0_make_backup( $placements ): void {
 ...
 * @return void
 */
function advads_upgrade_1_50_0_placement_migration(): void {
...
advads_upgrade_1_50_0_placement_migration();
